...
function CustomSlider(el, options) {
  ...
  this.windowResizeHandler = function () {
    if (window.innerWidth <= 767 && !_this.isInit) {
      _this.isInit = true;
      _this.swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](_this.el, _this.options);
    }
...
function Modal(element, overlay, buttons, closeButton, openClass, isOpen) {
  ...
  this.escapeKeydownHandler = function (event) {
    if (event.keyCode === _index__WEBPACK_IMPORTED_MODULE_0__["ESC_KEYCODE"]) {
      _this.toggleModal();
    }
  };
  /**
  ...
  this.openModal = function () {
    ...
    _this.element.classList.add(_this.openClass);

    _this.overlay.classList.add('overlay--open');

    document.querySelector('.page').classList.add('page--open-modal');

    _this.element.addEventListener('keydown', _this.escapeKeydownHandler);

    _this.overlay.addEventListener('click', _this.clickHandler);

    _this.closeButton.addEventListener('click', _this.clickHandler);

    _this.buttons.forEach(function (button) {
      button.removeEventListener('click', _this.clickHandler);
    });
  ...
  this.closeModal = function () {
    ...
    _this.element.classList.remove(_this.openClass);

    _this.overlay.classList.remove('overlay--open');

    document.querySelector('.page').classList.remove('page--open-modal');

    _this.element.removeEventListener('keydown', _this.escapeKeydownHandler);

    _this.overlay.removeEventListener('click', _this.clickHandler);

    _this.closeButton.removeEventListener('click', _this.clickHandler);

    _this.buttons.forEach(function (button) {
      button.addEventListener('click', _this.clickHandler);
    });
  ...
  this.modalFocus = function () {
    var input = _this.element.querySelector('input');

    if (_this.isOpen) {
      if (input && !_this.element.classList.contains('sidebar')) {
        input.focus();
      } else {
...
function ReadMore(button, buttonOpenClass, target, targetOpenClass) {
  var _this = this;

  var isOpen = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  var openText = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 'Закрыть';
  ...
  this.open = function () {
    _this.textContainer = _this.button.querySelector('span');
    _this.closeText = _this.textContainer.innerText;

    _this.target.classList.add(_this.targetOpenClass);

    _this.button.classList.add(_this.buttonOpenClass);

    _this.textContainer.innerText = _this.openText;
    _this.isOpen = true;
    window.addEventListener('keydown', _this.escapeKeydownHandler);
  };
  /**
  ...
  this.close = function () {
    _this.target.classList.remove(_this.targetOpenClass);

    _this.button.classList.remove(_this.buttonOpenClass);

    _this.textContainer.innerText = _this.closeText;
    _this.isOpen = false;
    window.removeEventListener('keydown', _this.escapeKeydownHandler);
  };
  /**
  ...
  this.use = function () {
    _this.button.addEventListener('click', _this.clickHandler);
  };
}
...
/* harmony import */ var _CustomSlider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CustomSlider */ "./src/js/CustomSlider.js");
/* harmony import */ var _Modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Modal */ "./src/js/Modal.js");
/* harmony import */ var _ReadMore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ReadMore */ "./src/js/ReadMore.js");
...
var ESC_KEYCODE = 27;
var sidebar = new _Modal__WEBPACK_IMPORTED_MODULE_2__["default"]('.sidebar', '.overlay--sidebar', '.sidebar-active-button', '.sidebar__close', 'sidebar--active', false);
var callback = new _Modal__WEBPACK_IMPORTED_MODULE_2__["default"]('.modal--callback', '.overlay--modal', '.callback-active-button', '.callback-close-button', 'modal--active', false);
var feedback = new _Modal__WEBPACK_IMPORTED_MODULE_2__["default"]('.modal--feedback', '.overlay--modal', '.feedback-active-button', '.feedback-close-button', 'modal--active', false);
var aboutReadMore = new _ReadMore__WEBPACK_IMPORTED_MODULE_3__["default"]('.about__more-button', 'more-button--open', '.about__text', 'about__text--open');
var brandReadMore = new _ReadMore__WEBPACK_IMPORTED_MODULE_3__["default"]('.more-button--brand', 'more-button--open', '.cards--brand', 'cards--active');
var deviceReadMore = new _ReadMore__WEBPACK_IMPORTED_MODULE_3__["default"]('.more-button--device', 'more-button--open', '.cards--device', 'cards--active');
var tableSlider = new _CustomSlider__WEBPACK_IMPORTED_MODULE_1__["default"]('.price-table', {
...
var brandSlider = new _CustomSlider__WEBPACK_IMPORTED_MODULE_1__["default"]('.cards--brand', {
...
var deviceSlider = new _CustomSlider__WEBPACK_IMPORTED_MODULE_1__["default"]('.cards--device', {
  wrapperClass: 'cards__container',
  slideClass: 'card',
  spaceBetween: 16,
  slidesPerView: 'auto',
